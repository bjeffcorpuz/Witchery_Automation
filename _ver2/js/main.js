...
//functions
function addSliceForm(col,extra,custom){
        ...
        <div class="container sliceForm${extraData}" data-column="2">
            ...
            <div class="col-12">
                <div class="input-group mb-2">
                    <div class="form-floating">
                        <div class="form-check text-start">
                            <input class="form-check-input showStatus" type="checkbox" value="" id="${genCode}-status">
        ...
        <div class="container custom sliceForm" data-column="custom">
            ...
            <div class="row collapse show" id="${genCode}">
                <div class="col-12">
                    <div class="input-group mb-2">
                        <div class="form-floating">
                        <textarea class="form-control customArea" aria-label="With textarea"></textarea>
                        </div>
                    </div>
                </div>  
                <div class="col-12">
...
function genHtml(sliceId){
    ...
    let link = `%%=RedirectTo(@Link${data.sliceID})=%%`
    ...
    html = `
\t\t\t<a href="${link}" target="_blank" alias="${alias}" style="font-family:Avenir, Helvetica, Arial, sans-serif; font-size:12px; color:#000000;">
...
$("#addSlice").click(function (e) { 
    //var x = "<span>{1,'coreLink'}</span><span>{2,'coreLink'}</span>";
    //console.log(getStringsInCurlyBraces(x));
